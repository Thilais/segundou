...
def gerar_titulo(transcricao, nome_especialista, consideracoes):
    resposta = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Você é um jornalista escrevendo uma matéria sobre uma reunião da equipe Santo Caos que aconteceu hoje. Com base nesta transcrição de reunião: {transcricao}, gerar um título curto e atraente para a matéria. Cite o nome do especialista {nome_especialista} que comentou sobre a reunião.Considere as suas seguintes consideraçõe {consideracoes} sobre o que achou da reunião para mudar o tom do texto e escolher o melhor titulo. Gere um titulo direto e impactante para a matéria. Não precisa mencionar a palavra titulo na sua geração. " }
        ]
    )
